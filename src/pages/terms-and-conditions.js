...
const TermsAndConditionsPage = () => (
  <>
    <Layout>
      ...
      <h2>Terms and Conditions for Selyt</h2>

      <h3>Introduction</h3>

      <p>
        These Website Standard Terms and Conditions written on this webpage
        shall manage your use of our website, Selyt accessible at
        https://selyt.pt.
      </p>
      ...
      <p>
        Other than the content you own, under these Terms, Selyt and/or its
      ...
      <p>
        ...
        and Selyt may further restrict access by you to any areas of this
      ...
      <p>
        ...
        display on this Website. By displaying Your Content, you grant Selyt a
      ...
      <p>
        ...
        rights. Selyt reserves the right to remove any of Your Content from this
      ...
      <p>
        This Website is provided "as is," with all faults, and Selyt express no
      ...
      <p>
        In no event shall Selyt, nor any of its officers, directors and
        ...
        under contract.  Selyt, including its officers, directors and employees
      ...
      <p>
        You hereby indemnify to the fullest extent Selyt from and against any
      ...
      <p>
        Selyt is permitted to revise these Terms at any time as it sees fit, and
      ...
      <p>
        The Selyt is allowed to assign, transfer, and subcontract its rights
      ...
      <p>
        These Terms constitute the entire agreement between Selyt and you in
      ...
      <p>
        ...
        laws of the State of Portugal, and you submit to the non-exclusive
        jurisdiction of the state and federal courts located in Portugal for the
